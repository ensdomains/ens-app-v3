...
const solcompile = promisify(solc.compile);
const pnp = findPnpApi("./");
const contracts = pnp.resolveToUnqualified("ens-contracts/contracts", "./");
...
const findImports = (ogPath) => (filePath) => {
  ...
  console.log("Continuing with path:", newPath);
  return {
...
module.exports = async (server) => {
  ...
  console.log("Deploying wrapper with account:", deployer.address);
