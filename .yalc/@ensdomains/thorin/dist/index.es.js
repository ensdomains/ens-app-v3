...
import Fm, { forwardRef as Vm, isValidElement as Gm, cloneElement as Zm, useState as zs, useRef as y0, useCallback as x0, useEffect as Mn } from "react";
...
function E0(r, n, a) {
  ...
  var o = !1, h = r.replace(Ns, function(u) {
    for (var v = arguments.length, y = new Array(v > 1 ? v - 1 : 0), g = 1; g < v; g++)
      y[g - 1] = arguments[g];
    var w = y[0], R = y[1], L = "".concat(w ? "-" : "").concat(R);
    return a != null && a[L] ? (o = !0, u) : n != null && n[L] ? n[L] : u;
  });
  return o ? !1 : h;
}
function Km(r, n) {
...
function _0(r, n, a, o) {
  ...
  if (u) {
    ...
    var R = Km(n, u);
    if (R) {
      var L = o ? R.conditions[o] : R.default;
      return a.set(g, L), L;
    }
  }
  if (h) {
  ...
  return function(o, h) {
    ...
    for (var R in h) {
      ...
      if (typeof L == "string" || typeof L == "number") {
        var C = void 0;
        if (n.has(L) ? C = n.get(L) : (C = E0("".concat(L), v, y), n.set(L, C)), !C)
          continue;
        r[u.conditions[R]] = C;
      }
    }
...
var Qm = function() {
  for (var n = arguments.length, a = new Array(n), o = 0; o < n; o++)
    a[o] = arguments[o];
  var h = Object.assign.apply(Object, [{}].concat(Ws(a.map(function(R) {
    return R.config;
  })))), u = Object.keys(h), v = new Set(u), y = u.filter(function(R) {
    return "mappings" in h[R];
  }), g = /* @__PURE__ */ new Map(), w = function(L) {
    var C = {}, F = [], B = {}, O = {}, V = fc({}, L), z = !1, T = S0(y), A;
    try {
      for (T.s(); !(A = T.n()).done; ) {
        var G = A.value, M = L[G];
        if (M != null) {
...
const De = {
  ...
  const n = Object.entries(r), a = n.map(([h, u]) => [h, u.primary]), o = n.reduce((h, [u, v]) => {
    const g = Object.entries(v).map(([w, R]) => [`${u}${w.charAt(0).toUpperCase()}${w.slice(1)}`, R]);
    return [...h, ...g];
  }, []);
...
const E = Vm(({
  ...
  if (Gm(r)) {
    const B = r;
    return h && console.log("as", R, L, w), Zm(B, {
      className: R,
      style: L,
      ...w
    });
  ...
  const F = r || "div";
  return h && console.log("as", R, L, w), /* @__PURE__ */ Fm.createElement(F, { className: R, ref: v, style: L, ...w }, o);
});
var t6 = "_19fuucx0";
const r6 = ({
  $shape: r,
  ...
  const R = l.useRef(null), [L, C] = l.useState(!!a), F = l.useCallback(() => {
    C(!0);
  }, [C]), B = l.useCallback(() => {
    C(!1);
  }, [C]);
  ...
  return /* @__PURE__ */ l.createElement(r6, { $shape: n, $size: g }, !O && /* @__PURE__ */ l.createElement(n6, { $disabled: u, $url: o, "aria-label": r }), /* @__PURE__ */ l.createElement("img", { className: V, style: z, ...T, alt: r, decoding: h, ref: R, src: a, onError: () => C(!1), onLoad: () => C(!0) }), A);
};
...
var i6 = (r, n, a) => {
  ...
  var n = (a) => {
    ...
    for (var [R, L] of r.compoundVariants)
      i6(R, h, r.defaultVariants) && (o += " " + L);
    return o;
  };
...
}, o6 = tn({ defaultClassName: "_1snez540", variantClassNames: { entered: { true: "_1snez541", false: "_1snez542" } }, defaultVariants: {}, compoundVariants: [] });
...
const A0 = {
...
}, er = (r, n) => A0[r][n] || A0.info[n], s6 = [...Ac, ...Ys, ...Xs], h6 = (r, n = "unset") => r && s6.includes(r) ? `$${r}` : n, On = (r) => Object.keys(r).reduce((a, o) => r[o] ? {
  ...a,
  [o]: r[o]
} : a, {}), T0 = {
  label: {
  ...
  textTransform: g,
  ...w
}, R) => /* @__PURE__ */ l.createElement(d6, { $color: v, $ellipsis: a ? !0 : void 0, $font: u, $fontVariant: h, $weight: y, as: r, className: o, ref: R, textTransform: g, ...On(w) }, n));
...
var Vt = Symbol("@ts-pattern/matcher"), Da = "@ts-pattern/anonymous-select-key", Sc = function(r) {
  ...
  if (Sc(n)) {
    ...
    return Object.keys(n).every(function(g) {
      var w, R = n[g];
      return (g in a || Ta(w = R) && w[Vt]().matcherType === "optional") && r(R, a[g], o);
    });
  }
...
const D6 = l.forwardRef(({
  ...
  E,
  {
    ...
    width: ["square", "circle"].includes(a) ? Tn(o, "height") : "$full",
    px: u ? "$12" : Tn(o, "px"),
    ...g
  }
)), N0 = ({
  $size: r,
  ...n
}) => /* @__PURE__ */ l.createElement(E, { display: "block", wh: Tn(r, "svgSize"), ...n }), F6 = ({
  $fullWidth: r,
  ...n
  ...
  return /* @__PURE__ */ l.createElement(
    ...
    he,
    /* @__PURE__ */ l.createElement(V6, null, /* @__PURE__ */ l.createElement(G6, { $colorStyle: L, $visible: !!T }, T))
  );
});
...
const z6 = (r) => /* @__PURE__ */ l.createElement(E, { backgroundColor: "$backgroundPrimary", borderColor: "$border", borderRadius: "$2xLarge", borderStyle: "solid", borderWidth: "$1x", display: "flex", flexDirection: "column", gap: "$4", padding: {
  ...
  children: n,
  ...a
}) => /* @__PURE__ */ l.createElement(z6, { ...On(a) }, r && /* @__PURE__ */ l.createElement(Pe, { fontVariant: "headingFour" }, r), n);
Dc.displayName = "Card";
Dc.Divider = H6;
const Cc = 0, _c = 1, Fa = 2, Va = 3, Ga = 4, I6 = 5, r1 = 6, W6 = ["preEnter", "entering", "entered", "preExit", "exiting", "exited", "unmounted"], n1 = (r) => ({
  ...
  const [w, R] = zs(() => n1(u ? Fa : kc(v))), L = y0(w), C = y0(), [F, B] = j6(h), O = x0(() => {
    const z = N6(L.current._s, y);
    z && j0(z, R, L, C, g);
  }, [g, y]), V = x0((z) => {
    const T = (G) => {
      switch (j0(G, R, L, C, g), G) {
        case _c:
          F >= 0 && (C.current = setTimeout(O, F));
          break;
        case Ga:
          B >= 0 && (C.current = setTimeout(O, B));
          break;
        case Cc:
        case Va:
          C.current = q6(T, G);
  ...
  return Mn(() => () => clearTimeout(C.current), []), [w, V, O];
};
...
(function(r, n) {
  (function() {
    var a, o = "4.17.21", h = 200, u = "Unsupported core-js use. Try https://npms.io/search?q=ponyfill.", v = "Expected a function", y = "Invalid `variable` option passed into `_.template`", g = "__lodash_hash_undefined__", w = 500, R = "__lodash_placeholder__", L = 1, C = 2, F = 4, B = 1, O = 2, V = 1, z = 2, T = 4, A = 8, G = 16, M = 32, K = 64, ae = 128, ce = 256, he = 512, de = 30, xe = "...", me = 800, J = 16, te = 1, ue = 2, q = 3, W = 1 / 0, le = 9007199254740991, Ae = 17976931348623157e292, Fe = 0 / 0, ge = 4294967295, Pt = ge - 1, _e = ge >>> 1, Te = [
      ["ary", ae],
      ["bind", V],
      ["bindKey", z],
      ["curry", A],
    ...
    Se[ln] = Se[Mr] = Se[cn] = Se[Or] = Se[on] = Se[sn] = Se[hn] = Se[dn] = Se[un] = !0, Se[Be] = Se[vt] = Se[gr] = Se[mt] = Se[pr] = Se[it] = Se[$e] = Se[gt] = Se[Ke] = Se[pt] = Se[yt] = Se[ot] = Se[Ne] = Se[vr] = Se[mr] = !1;
    var Ee = {};
    Ee[Be] = Ee[vt] = Ee[gr] = Ee[pr] = Ee[mt] = Ee[it] = Ee[ln] = Ee[Mr] = Ee[cn] = Ee[Or] = Ee[on] = Ee[Ke] = Ee[pt] = Ee[yt] = Ee[ot] = Ee[Ne] = Ee[vr] = Ee[Br] = Ee[sn] = Ee[hn] = Ee[dn] = Ee[un] = !0, Ee[$e] = Ee[gt] = Ee[mr] = !1;
    var Jh = {
      \u00C0: "A",
      \u00C1: "A",
      \u00C2: "A",
    ...
    var Rd = function p(S) {
      ...
      ), Jn = ui ? S.Buffer : a, lr = S.Symbol, Qn = S.Uint8Array, Pi = Jn ? Jn.allocUnsafe : a, ea = ki(we.getPrototypeOf, we), Ai = we.create, Ti = zr.propertyIsEnumerable, ta = Un.splice, Bi = lr ? lr.isConcatSpreadable : a, fn = lr ? lr.iterator : a, xr = lr ? lr.toStringTag : a, ra = function() {
        try {
          var e = Cr(we, "defineProperty");
          return e({}, "", {}), e;
        } catch {
        }
      }(), Od = S.clearTimeout !== He.clearTimeout && S.clearTimeout, Dd = Z && Z.now !== He.Date.now && Z.now, Fd = S.setTimeout !== He.setTimeout && S.setTimeout, na = Ve.ceil, aa = Ve.floor, wl = we.getOwnPropertySymbols, Vd = Jn ? Jn.isBuffer : a, Mi = S.isFinite, Gd = Un.join, Zd = ki(we.keys, we), Ge = Ve.max, qe = Ve.min, zd = Z.now, Hd = S.parseInt, Oi = Ve.random, Id = Un.reverse, $l = Cr(S, "DataView"), vn = Cr(S, "Map"), El = Cr(S, "Promise"), Hr = Cr(S, "Set"), mn = Cr(S, "WeakMap"), gn = Cr(we, "create"), la = mn && new mn(), Ir = {}, Wd = _r($l), Nd = _r(vn), jd = _r(El), qd = _r(Hr), Ud = _r(mn), ca = lr ? lr.prototype : a, pn = ca ? ca.valueOf : a, Di = ca ? ca.toString : a;
      function d(e) {
      ...
      function tu(e) {
        var t = this.__data__;
        return gn ? t[e] !== a : pe.call(t, e);
      }
      function ru(e, t) {
        var c = this.__data__;
        return this.size += this.has(e) ? 0 : 1, c[e] = gn && t === a ? g : t, this;
      }
      ...
      function St(e, t, c, i, s, b) {
        ...
        return wt(re || e, function(Y, ie) {
          re && (ie = Y, Y = e[ie]), yn(f, ie, St(Y, t, c, ie, e, b));
        }), f;
      }
      function Su(e) {
        var t = Ze(e);
      ...
      function xn(e, t, c, i) {
        ...
        if (!m)
          return x;
        c && (t = Ce(t, ht(c))), i ? (b = dl, f = !1) : t.length >= h && (b = bn, f = !1, t = new $r(t));
        e:
          for (; ++s < m; ) {
      ...
      function Ll(e, t, c) {
        ...
        e:
          for (; ++P < s && _.length < x; ) {
            var H = k[P], U = t ? t(H) : H;
            if (H = c || H !== 0 ? H : 0, !(D ? bn(D, U) : i(_, U, c))) {
              for (f = b; --f; ) {
                var re = m[f];
                if (!(re ? bn(re, U) : i(e[f], U, c)))
                  continue e;
              }
              D && D.push(U), _.push(H);
            }
      ...
      function $n(e, t, c, i, s) {
        return e === t ? !0 : e == null || t == null || !Re(e) && !Re(t) ? e !== e && t !== t : Bu(e, t, c, i, $n, s);
      }
      ...
      function Xi(e, t) {
        return Yl(e) && Po(t) ? Ao(Ht(e), t) : function(c) {
          var i = lc(c, e);
          return i === a && i === t ? cc(c, e) : $n(t, i, B | O);
        };
      }
      ...
      function Gu(e, t, c, i, s, b, f) {
        ...
        if (P) {
          ...
          k = x, D || H || U ? Q(m) ? k = m : Me(m) ? k = et(m) : H ? (P = !1, k = so(x, !0)) : U ? (P = !1, k = ho(x, !0)) : k = [] : kn(x) || kr(x) ? (k = m, kr(m) ? k = i0(m) : (!ke(m) || Kt(m)) && (k = Lo(x))) : P = !1;
        }
      ...
      function yo(e) {
        return Ut(function(t) {
          ...
          for (i = f ? i : c; ++i < c; ) {
            ...
            x && Kl(x[0]) && x[1] == (ae | A | M | ce) && !x[4].length && x[9] == 1 ? f = f[ya(x[0])].apply(f, x[3]) : f = b.length == 1 && Kl(b) ? f[m]() : f.thru(b);
          }
          return function() {
      ...
      function va(e, t, c, i, s, b, f, m, x, _) {
        var k = t & ae, P = t & V, D = t & z, H = t & (A | G), U = t & he, re = D ? a : Sn(e);
        function Y() {
          ...
          return ie = se.length, m ? se = $b(se, m) : U && ie > 1 && se.reverse(), k && x < ie && (se.length = x), this && this !== He && this instanceof Y && (Jt = re || Sn(Jt)), Jt.apply(Ot, se);
        }
        return Y;
      }
      function xo(e, t) {
      ...
      function qt(e, t, c, i, s, b, f, m) {
        ...
        if (!x && typeof e != "function")
          throw new $t(v);
        var _ = i ? i.length : 0;
        if (_ || (t &= ~(M | K), i = s = a), f = f === a ? f : Ge(ee(f), 0), m = m === a ? m : ee(m), _ -= s ? s.length : 0, t & K) {
          var k = i, P = s;
          i = s = a;
        }
        var D = x ? a : jl(e), H = [
        ...
        if (D && yb(H, D), e = H[0], t = H[1], c = H[2], i = H[3], s = H[4], m = H[9] = H[9] === a ? x ? 0 : e.length : Ge(H[9] - _, 0), !m && t & (A | G) && (t &= ~(A | G)), !t || t == V)
          ...
          t == A || t == G ? U = rb(e, t, m) : (t == M || t == (V | M)) && !s.length ? U = nb(e, t, c, i) : U = va.apply(a, H);
        var re = D ? ro : Mo;
      ...
      ($l && Ue(new $l(new ArrayBuffer(1))) != pr || vn && Ue(new vn()) != Ke || El && Ue(El.resolve()) != zn || Hr && Ue(new Hr()) != Ne || mn && Ue(new mn()) != mr) && (Ue = function(e) {
      ...
      function Lo(e) {
        return typeof e.constructor == "function" && !Cn(e) ? Wr(ea(e)) : {};
      }
      function ub(e, t, c) {
        var i = e.constructor;
        switch (t) {
...
`);
      ...
      function yb(e, t) {
        ...
        if (m) {
          var x = e[3];
          e[3] = x ? bo(x, m, t[4]) : m, e[4] = x ? ar(e[3], R) : t[4];
        }
        return m = t[5], m && (x = e[5], e[5] = x ? fo(x, m, t[6]) : m, e[6] = x ? ar(e[5], R) : t[6]), m = t[7], m && (e[7] = m), i & ae && (e[8] = e[8] == null ? t[8] : qe(e[8], t[8])), e[9] == null && (e[9] = t[9]), e[0] = t[0], e[1] = s, e;
      }
      function xb(e) {
        var t = [];
        if (e != null)
      ...
      var Mo = Do(ro), _n = Fd || function(e, t) {
      ...
      var kb = ne(function(e, t) {
        return Me(e) ? xn(e, Ie(t, 1, Me, !0)) : [];
      }), Rb = ne(function(e, t) {
        var c = _t(t);
        return Me(c) && (c = a), Me(e) ? xn(e, Ie(t, 1, Me, !0), j(c, 2)) : [];
      }), Lb = ne(function(e, t) {
        var c = _t(t);
        return Me(c) && (c = a), Me(e) ? xn(e, Ie(t, 1, Me, !0), a, c) : [];
      });
      function Pb(e, t, c) {
        var i = e == null ? 0 : e.length;
      ...
      function Qo(e, t, c) {
        ...
        function U(Oe) {
          return _ = Oe, m = _n(ie, t), k ? H(Oe) : f;
        }
        function re(Oe) {
        ...
        function ft() {
          ...
          if (i = arguments, s = this, x = Oe, Ot) {
            if (m === a)
              return U(x);
            if (P)
              return oo(m), m = _n(ie, t), H(x);
          }
          return m === a && (m = _n(ie, t)), f;
        }
      ...
      function xf(e, t) {
        return t = typeof t == "function" ? t : a, St(e, L | F, t);
      }
      function wf(e, t) {
      ...
      function Pf(e, t, c) {
        ...
        var i = c ? c(e, t) : a;
        return i === a ? $n(e, t, a, c) : !!i;
      }
      function nc(e) {
        if (!Re(e))
          return !1;
        var t = Xe(e);
        return t == $e || t == fr || typeof e.message == "string" && typeof e.name == "string" && !kn(e);
      }
      function Af(e) {
      ...
      function mv(e, t, c) {
        return e == null ? e : En(e, t, c);
      }
      function gv(e, t, c, i) {
        return i = typeof i == "function" ? i : a, e == null ? e : En(e, t, c, i);
      }
...
`) + P + `return __p
      ...
      function sc(e) {
        return Ui(typeof e == "function" ? e : St(e, L));
      }
      function am(e) {
        return Ki(St(e, L));
      }
...
const q0 = (r, n, a, o, h) => {
  ...
  $hideOverflow: g,
  ...w
}, R) => /* @__PURE__ */ l.createElement(E, { ...w, boxSizing: "border-box", className: Y6, display: "block", fontFamily: "$sans", left: Kr(r.status, "leftFunc")(u), opacity: Kr(r.status, "opacity"), overflow: g ? "hidden" : "visible", pointerEvents: Kr(r.status, "pointerEvents"), position: "absolute", ref: R, top: Kr(r.status, "topFunc")(v), transform: {
  ...
  additionalGap: w = 0,
  transitionDuration: R = 350,
  isOpen: L,
  align: C = "center",
  hideOverflow: F
}) => {
  const B = l.useRef(), O = L !== void 0, [V, z] = l.useState({
    top: 100,
    left: 100,
  ...
  l.useEffect(() => {
    ...
    return addEventListener("resize", me), () => {
      O || (te == null || te.removeEventListener("mouseenter", ue), te == null || te.removeEventListener("mouseleave", q), J == null || J.removeEventListener("mouseenter", ue), J == null || J.removeEventListener("mouseleave", q), document.removeEventListener("mousemove", W)), removeEventListener("resize", me);
    };
  }, [n, a, T, V, w, u, h, O]), l.useEffect(() => (O && K(L), () => K(!1)), [O, L]);
  const [M, K] = Fc({
    preEnter: !0,
    exit: !0,
    mountOnEnter: !0,
  ...
  console.log("state", M);
  const ae = g ? V.idealPlacement : n, ce = g ? V.idealMobilePlacement : a, {
    translate: he,
    mobileTranslate: de
...
const J6 = (r, n, a, o) => {
  ...
  Mn(() => (o ? document.addEventListener(n, h) : document.removeEventListener(n, h), () => {
...
const qa = () => {
  ...
  let O;
  typeof r == "function" ? O = /* @__PURE__ */ l.createElement(X0.Provider, { value: B }, /* @__PURE__ */ l.createElement(X0.Consumer, null, (T) => r(T))) : r ? O = l.cloneElement(r, B.content) : O = r;
  ...
  return g ? /* @__PURE__ */ l.createElement(J0, { $inline: g, $reverse: L, $width: R }, /* @__PURE__ */ l.createElement("div", null, O), /* @__PURE__ */ l.createElement(dg, null, V, z)) : /* @__PURE__ */ l.createElement(J0, { $width: R }, V, O, z);
};
...
const ug = (r, n) => {
  ...
  const T = l.useRef(null), A = z || T, [G, M] = l.useState(es), K = u ? !0 : void 0, ae = a1({
    id: v,
    error: K
    ...
    (q) => {
      q.preventDefault(), M(es), A.current && (A.current.value = ""), O && O();
    },
    [A, O]
  );
  return l.useEffect(() => {
  ...
  }, [G.file]), /* @__PURE__ */ l.createElement("div", null, /* @__PURE__ */ l.createElement(Pr, null, /* @__PURE__ */ l.createElement("input", { ...V, ...ae.content, accept: r, "aria-invalid": K, autoFocus: n, disabled: h, name: g, ref: A, required: w, tabIndex: R, type: "file", onBlur: te, onChange: he, onFocus: J })), /* @__PURE__ */ l.createElement("label", { ...ae.label, onDragLeave: xe, onDragOver: de, onDrop: me }, a({
    ...G,
    reset: ue
  })));
});
...
const vg = () => {
  ...
  const {
    ...
    ...w
  }, F = !!h || !!u, B = !!u || !!v, O = typeof u == "string" ? /* @__PURE__ */ l.createElement(Pe, { color: "grey", ellipsis: !o, fontVariant: a === "large" ? "bodyBold" : "smallBold", textAlign: "left", width: "$full" }, u) : u, V = typeof v == "string" ? /* @__PURE__ */ l.createElement(Pe, { color: "grey", ellipsis: !o, fontVariant: a === "large" ? "smallBold" : "extraSmallBold", textAlign: "left", width: "$full" }, v) : v, z = n ? {
    $rotate: !0,
    as: p1
  } : L ? {
    as: Gn
  ...
  return /* @__PURE__ */ l.createElement(mg, { $inline: o, as: r, ...C }, F && /* @__PURE__ */ l.createElement(gg, { $inline: o, $size: a }, h && /* @__PURE__ */ l.createElement(yg, { as: h }), B && /* @__PURE__ */ l.createElement(pg, { $inline: o }, O, V)), /* @__PURE__ */ l.createElement(Pe, { flex: "1", fontVariant: a === "large" ? "body" : "small", textAlign: "left", wordBreak: o ? "normal" : "break-all" }, g), /* @__PURE__ */ l.createElement(xg, { ...z }));
};
...
const $g = l.forwardRef((r, n) => /* @__PURE__ */ l.createElement(E, { overflowX: "auto", overflowY: "auto", position: "relative", ref: n, transitionDuration: "$150", transitionProperty: "all", transitionTimingFunction: "$inOut", ...r })), ts = ({
  ...
  const y = l.useRef(null), g = l.useRef(null), w = l.useRef(null), R = typeof r == "boolean" ? r : !!(r != null && r.top), L = typeof r == "boolean" ? r : !!(r != null && r.bottom), C = l.useRef({
    onReachedTop: o,
    onReachedBottom: h
  }), [F, B] = l.useState(!1), [O, V] = l.useState(!1), z = (T) => {
    var M, K, ae, ce;
    const A = [!1, -1], G = [!1, -1];
    ...
    A[1] !== -1 && !R && B(!A[0]), G[1] !== -1 && !L && V(!G[0]), A[0] && ((K = (M = C.current).onReachedTop) == null || K.call(M)), G[0] && ((ce = (ae = C.current).onReachedBottom) == null || ce.call(ae));
  };
  return l.useEffect(() => {
    const T = y.current, A = g.current, G = w.current;
    let M;
    return T && A && G && (M = new IntersectionObserver(z, {
      root: T,
      threshold: 1,
      rootMargin: `${n}px 0px ${a}px 0px`
    }), M.observe(A), M.observe(G)), () => {
      M.disconnect();
    };
  }, [a, n]), l.useEffect(() => {
    C.current = {
    ...
    /* @__PURE__ */ l.createElement(ts, { position: "bottom", show: O })
  );
};
var Eg = "krcy0m1";
...
const Sg = (r, n) => fe(n).with("background", () => `$${r}Primary`).with("content", () => "$textAccent").with("hover", () => `$${r}Bright`).exhaustive(), Cg = (r, n) => fe(n).with("background", () => `$${r}Surface`).with("content", () => `$${r}Primary`).with("hover", () => `$${r}Light`).exhaustive(), Pa = (r, n) => {
  ...
  hover: Le(a ? -1 : 0),
  active: Le(-1)
}, transitionDuration: "$150", transitionProperty: "color, border-color, background-color, transform", transitionTimingFunction: "$inOut", width: "$max", ...u }, n);
Gc.displayName = "Tag";
const d1 = l.createContext(null), _g = ({
  ...
  const [y, g] = Fc({
    ...
    mountOnEnter: !0,
    unmountOnExit: !0
  }), w = l.useRef(null), R = n || Oc, L = (C) => C.target === w.current && a && a();
  return l.useEffect(() => {
    const {
      style: C,
      dataset: F
    } = document.body, B = () => parseInt(F.backdrops || "0"), O = (z) => F.backdrops = String(B() + z), V = (z, T, A) => {
      C.width = z, C.position = T, C.top = A;
    };
    return g(u || !1), typeof window < "u" && !o && u ? (B() === 0 && V(`${document.body.clientWidth}px`, "fixed", `-${window.scrollY}px`), O(1), () => {
      g(!1);
  ...
  }, [u, o]), y.status !== "unmounted" ? /* @__PURE__ */ l.createElement(Na, { className: h, renderCallback: v }, a && /* @__PURE__ */ l.createElement(R, { $empty: o, $state: y.status, ref: w, onClick: L }), r({
    state: y
  })) : null;
};
...
const Tg = (r = "", n = 10, a = 5, o = 5) => r.length < n ? r : `${r.slice(0, a)}...${r.slice(-o)}`, br = (r, n) => r["data-testid"] ? String(r["data-testid"]) : n, Bg = l.forwardRef(({
  ...
  const G = l.useRef(null), M = A || G;
  return /* @__PURE__ */ l.createElement(ur, { description: r, disabled: n, error: a, hideLabel: o, id: h, inline: y, label: u, labelSecondary: v, required: w, width: F }, /* @__PURE__ */ l.createElement(Bg, { $colorStyle: z, "aria-invalid": a ? !0 : void 0, checked: C, "data-testid": br(T, "checkbox"), disabled: n, id: h, name: g, ref: M, tabIndex: R, value: L, onBlur: B, onChange: O, onFocus: V, ...T }));
});
...
const Ng = ({
  ...
  titleId: n,
  ...a
}) => /* @__PURE__ */ l.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "currentColor", viewBox: "0 0 96 96", width: "1em", height: "1em", focusable: "false", shapeRendering: "geometricPrecision", "aria-labelledby": n, ...a }, r ? /* @__PURE__ */ l.createElement("title", { id: n }, r) : null, /* @__PURE__ */ l.createElement("path", { fill: "currentColor", d: "M17.757 26.243a6 6 0 1 1 8.486-8.486L48 39.515l21.757-21.758a6 6 0 1 1 8.486 8.486L56.485 48l21.758 21.757a6 6 0 1 1-8.486 8.486L48 56.485 26.243 78.243a6 6 0 1 1-8.486-8.486L39.515 48 17.757 26.243Z" })), rn = ({
  title: r,
  titleId: n,
  ...a
...
const E1 = {
  ...
  const a = Object.entries({
    ...
    for (const [g, w] of Object.entries(y.items)) {
      const R = `${v}${g.replace(/^[a-z]/, (C) => C.toUpperCase())}`, L = typeof w == "string" ? a.raw[`${y.hue}${w}`] : w[n];
      if (h[R] = `hsl(${L})`, h.raw[R] = L, g === "primary") {
        const C = v;
        h[C] = `hsl(${L})`, h.raw[C] = L;
      }
    }
...
const C8 = l.forwardRef((r, n) => /* @__PURE__ */ l.createElement(E, { ...r, display: "flex", flexDirection: "column", gap: "$2.5", padding: "$2.5", ref: n, width: "$full" })), _8 = (r) => /* @__PURE__ */ l.createElement(E, { ...r, borderRadius: "$large", display: "flex", flexDirection: "column", gap: "$px", textAlign: "center", width: "$full" }), k8 = (r) => /* @__PURE__ */ l.createElement(E, { ...r, alignItems: "center", backgroundColor: "$backgroundPrimary", className: S8, color: "$textPrimary", display: "flex", gap: "$2", justifyContent: "center", padding: "$5", position: "relative", width: "$full" }), R8 = l.forwardRef(({
  ...
  children: h,
  ...u
}) => /* @__PURE__ */ l.createElement(E, { ...u, alignItems: "center", backgroundColor: {
...
}, fontWeight: "$normal", gap: "$2", height: "$12", justifyContent: "flex-start", padding: "$3", paddingRight: a ? "$6" : "$3", position: "relative", transform: {
  base: "translateY(0px)",
  ...
  return u ? /* @__PURE__ */ l.createElement(fs, { ...L }, /* @__PURE__ */ l.createElement(Ua, { paddingRight: "$1", style: {
    height: u
  } }, R)) : /* @__PURE__ */ l.createElement(fs, { ...L }, /* @__PURE__ */ l.createElement(E, { alignItems: "center", display: "flex", flexDirection: "column", gap: "$1", justifyContent: "center", width: "$full" }, R));
  ...
  const R = l.useMemo(() => y.some((C) => "showIndicator" in C && C.showIndicator), [y]), L = l.useMemo(() => ({
    ...g,
    "data-indicator": R && !h,
    style: {
  ...
  return /* @__PURE__ */ l.createElement(l.Fragment, null, r ? l.Children.map(r, (C) => l.isValidElement(C) ? l.cloneElement(C, {
    ...
    onClick: () => u((F) => !F),
    ref: n
  }) : null) : /* @__PURE__ */ l.createElement(Wa, { "data-testid": "dropdown-btn", pressed: h, ref: n, suffix: a && /* @__PURE__ */ l.createElement(A8, { $direction: o, $open: h }), width: "$fit", onClick: () => u((C) => !C), ...L }, v));
}, B8 = () => {
  ...
  const z = l.useRef(), T = l.useRef(null), A = l.useRef(null), G = l.useState(!1), [M, K] = C ? [L, C] : G;
  M8(z, T, A, K, M);
  const ae = B8();
  return /* @__PURE__ */ l.createElement(l.Fragment, null, /* @__PURE__ */ l.createElement(T8, { children: r, buttonRef: T, chevron: o, direction: R, isOpen: M, setIsOpen: K, label: w, items: a, buttonProps: n, indicatorColor: F }), fe({
    responsive: B,
    screenSize: ae
  }).with({
    responsive: !1,
  ...
  }, () => /* @__PURE__ */ l.createElement(ja, { additionalGap: -10, align: h === "left" ? "start" : "end", anchorRef: T, hideOverflow: !g, isOpen: M, mobilePlacement: R === "down" ? "bottom" : "top", mobileWidth: v, placement: R === "down" ? "bottom" : "top", popover: /* @__PURE__ */ l.createElement(
    L8,
    {
      ...V,
      direction: R,
    ...
    responsive: !0,
    screenSize: ye.when((ce) => ce < Fn.sm)
  }, () => /* @__PURE__ */ l.createElement(R8, { isOpen: M, screenSize: ae, items: a, setIsOpen: K, DropdownChild: D1, cancelLabel: O, ref: A })).otherwise(() => /* @__PURE__ */ l.createElement("div", null)));
};
...
var Hc = tn({ defaultClassName: "_1avz0ws0", variantClassNames: { show: { true: "_1avz0ws1" }, validated: { true: "_1avz0ws2" }, error: { true: "_1avz0ws3" } }, defaultVariants: {}, compoundVariants: [] });
var Ic = tn({ defaultClassName: "_6arcis0", variantClassNames: { readonly: { true: "_6arcis1" }, error: { true: "_6arcis2" }, disabled: { true: "_6arcis3" } }, defaultVariants: {}, compoundVariants: [] });
const H8 = (r, n) => {
  var u, v;
...
var I8 = "_189z23r1", W8 = tn({ defaultClassName: "_189z23r2", variantClassNames: { size: { small: "_189z23r3", medium: "_189z23r4", large: "_189z23r5", extraLarge: "_189z23r6" }, showAction: { true: "_189z23r7" } }, defaultVariants: {}, compoundVariants: [] }), gs = "_189z23r0";
const ps = {
  small: {
    outerPadding: "$3.5",
    innerPadding: "$1.75",
  ...
  const o = l.isValidElement(r) ? r : /* @__PURE__ */ l.createElement(rn, null);
  ...
  return /* @__PURE__ */ l.createElement(ur, { description: h, disabled: u, error: v, hideLabel: w, id: R, label: V, labelSecondary: z, readOnly: K, required: ae, width: q }, ($e) => /* @__PURE__ */ l.createElement(N8, { className: Hc({
    error: Ye,
    validated: y,
    show: g
    ...
    G && /* @__PURE__ */ l.createElement(ys, { "aria-hidden": "true", as: M, className: gs, order: -2, ...$e == null ? void 0 : $e.label, $disabled: u, $size: ge }, G),
...
const ws = {
  ...
  base: "$background",
  hover: "$greySurface"
}, border: "1px solid", borderColor: "$border", borderRadius: Rn(n, "borderRadius"), color: r ? "$accent" : "$greyPrimary", cursor: r ? "default" : "pointer", fontSize: Rn(n, "fontSize"), fontWeight: "$bold", height: Rn(n, "height"), lineHeight: Rn(n, "lineHeight"), minWidth: Rn(n, "minWidth"), padding: "$2", pointerEvents: r ? "none" : "auto", transition: "all 0.15s ease-in-out" }), Q8 = (r) => /* @__PURE__ */ l.createElement(E, { ...r, as: "p", color: "$greyPrimary", fontSize: "$small", fontWeight: "$bold" }), Z1 = ({
  total: r,
  current: n,
  max: a = 5,
  size: o = "medium",
  ...
  const w = Math.floor(a / 2), R = Math.max(Math.min(Math.max(n - w, 1), r - a + 1), 1), L = Array.from({
    length: a
  }, (C, F) => R + F).filter((C) => C <= r);
  return r > a && (h && R > 1 ? v ? (L[0] = -1, L.unshift(1)) : L[0] = 1 : v && R > 1 && L.unshift(-1), u && r > n + w ? v ? (L[L.length - 1] = -1, L.push(r)) : L[L.length - 1] = r : v && r > n + w && L.push(-1)), /* @__PURE__ */ l.createElement(X8, { ...g, "data-testid": br(g, "pagebuttons") }, L.map((C, F) => C === -1 ? /* @__PURE__ */ l.createElement(Q8, { "data-testid": "pagebutton-dots", key: `${C}-${F}` }, "...") : /* @__PURE__ */ l.createElement(J8, { $selected: C === n, $size: o, "data-testid": "pagebutton", key: C, type: "button", onClick: () => y(C) }, C)));
};
...
const $s = {
  ...
  base: Bn(1),
  hover: Bn(n ? 1.05 : 1)
}, flexDirection: "row", gap: "$2", height: Ln(r, "height"), justifyContent: "flex-start", maxWidth: Ln(r, "maxWidth"), padding: Ln(r, "padding"), paddingRight: Ln(r, "paddingRight"), position: "relative", ref: h, transform: {
  base: Le(0),
  hover: Le(n ? -1 : 0)
}, transitionDuration: "$150", transitionProperty: "color, border-color, background-color, transform, filter", transitionTimingFunction: "$inOut", width: Ln(r, "width"), zIndex: 10, ...o })), t5 = ({
  $size: r,
  ...n
  ...
  return a ? /* @__PURE__ */ l.createElement(zc, { width: e5(r), indicatorColor: v, items: a, isOpen: g, setIsOpen: w, align: u, responsive: !1 }, /* @__PURE__ */ l.createElement(Es, { $hasDropdown: !0, $open: g, $size: r, onClick: () => w(!g), ...On(y) }, /* @__PURE__ */ l.createElement(Ss, { size: r, avatar: n, address: o, ensName: h }))) : /* @__PURE__ */ l.createElement(Es, { $open: g, $size: r, "data-testid": br(y, "profile"), ...On(y) }, /* @__PURE__ */ l.createElement(Ss, { size: r, avatar: n, address: o, ensName: h }));
};
...
const l5 = (r = "accent") => {
  ...
  const G = l.useRef(null), M = A || G;
  return /* @__PURE__ */ l.createElement(ur, { description: r, error: a, hideLabel: h, id: u, inline: o, label: v, labelSecondary: y, required: w, width: F, disabled: n }, /* @__PURE__ */ l.createElement(i5, { ...T, $color: B, "aria-invalid": a ? !0 : void 0, "aria-selected": C ? !0 : void 0, checked: C, className: a5, "data-testid": br(T, "radio"), disabled: n, id: u, name: g, ref: M, tabIndex: R, value: L, onBlur: O, onChange: V, onFocus: z }));
});
...
const I1 = (r) => {
  ...
  const y = l.useRef(null), g = v || y, w = l.useRef(null), [R, L] = l.useState(!1), [C, F] = l.useState(r);
  l.useEffect(() => {
    r && r != C && F(r);
  }, [r]);
  const B = (T) => {
  ...
  return /* @__PURE__ */ l.createElement(o5, { ...u, $inline: a, "data-testid": br(u, "radiogroup"), ref: g, role: "radiogroup", onFocus: O }, l.Children.map(n, (T) => {
    T.props.checked && !R && (L(!0), C !== T.props.value && (F(T.props.value), L(!0), z(T.props.value, T.props.name)));
...
var p5 = g5, y5 = Array.isArray, x5 = y5, Cs = Wc, N1 = Object.prototype, w5 = N1.hasOwnProperty, $5 = N1.toString, Pn = Cs ? Cs.toStringTag : void 0;
function E5(r) {
  var n = w5.call(r, Pn), a = r[Pn];
  try {
    r[Pn] = void 0;
    var o = !0;
  } catch {
  ...
  var h = $5.call(r);
  return o && (n ? r[Pn] = a : delete r[Pn]), h;
}
...
const As = {
  ...
  $disabled: n,
  ...a
}) => /* @__PURE__ */ l.createElement(E, { ...a, alignItems: "center", as: "button", color: "$greyPrimary", cursor: n ? "not-allowed" : "pointer", display: "flex", height: "$full", justifyContent: "flex-end", margin: "$0", padding: "$0", paddingLeft: "$2", paddingRight: lt(r, "outerPadding") }, /* @__PURE__ */ l.createElement(E, { as: /* @__PURE__ */ l.createElement(rn, null), display: "block", wh: lt(r, "iconWidth") })), i3 = ({
  $open: r,
  $direction: n,
  $size: a,
  $disabled: o,
  ...
  $align: o,
  ...h
}) => /* @__PURE__ */ l.createElement(E, { ...h, backgroundColor: "$backgroundPrimary", borderColor: "$border", borderRadius: "$2xLarge", borderStyle: "solid", borderWidth: "$1x", bottom: An(r, "bottom", n), display: r === "exited" ? "none" : "block", fontSize: lt(a, "fontSize"), left: o === "left" ? 0 : "unset", lineHeight: "$body", minWidth: "$full", opacity: An(r, "opacity", n), overflow: "hidden", padding: "$2", position: "absolute", right: o === "right" ? 0 : "unset", top: An(r, "top", n), transition: "all 0.3s cubic-bezier(1, 0, 0.22, 1.6), z-index 0.3s linear", visibility: An(r, "visibility", n), zIndex: An(r, "zIndex", n) }), s3 = ({
  $rows: r,
  $direction: n,
  $size: a = "medium",
  children: o,
...
const b3 = (r, n, a) => typeof a == "string" ? a : (a == null ? void 0 : a[r]) || n, Bs = (r, n, a) => typeof a == "number" ? a : (a == null ? void 0 : a[r]) || n, U1 = l.forwardRef(({
  ...
  const le = l.useRef(null), Ae = W || le, Fe = l.useRef(null), ge = l.useRef(null), [Pt, _e] = l.useState(""), [Te, Be] = l.useState(""), vt = o && Te !== "", Ye = o || a, [mt] = l.useState(R || Q5()), [it, fr] = l.useState("");
  l.useEffect(() => {
    he !== it && he !== void 0 && fr(he);
  }, [he]);
  const $e = (M == null ? void 0 : M.find((I) => I.value === it)) || null, gt = (I, N) => {
    ...
    const I = Te.trim().toLowerCase(), {
      options: N,
      exactMatch: je
    } = (Array.isArray(M) ? M : [M]).reduce(u3(I), {
      options: [],
      exactMatch: !1
    });
    return [...N, ...vt && !je ? [{
  ...
  }, [M, vt, Ye, Te, h]), [Ke, pt] = l.useState(-1), Tr = l.useCallback((I) => {
    const N = At[I];
    ...
    const N = At[Ke];
    N && gt(N, I), Mr();
  }, [Gt, ot] = l.useState(!1), Ne = !n && Gt, vr = Te !== "" && Ye, Br = Bs("min", 4, me), Qa = Bs("max", 20, me), mr = Math.min(Math.max(Br, Te.length), Qa), [an, gr] = Fc({
    timeout: {
      enter: 0,
      exit: 300
    },
  ...
  Mn(() => {
    ...
    !Gt && an.status === "unmounted" && Mr();
  }, [Gt, an.status]);
  const ln = b3("inner", de === "small" ? "3" : "4", xe), Mr = () => {
    Be(""), _e(""), pt(-1);
  }, cn = () => {
    Ye && !Gt && ot(!0), Ye || ot(!Gt);
  }, Or = (I) => {
  ...
  return /* @__PURE__ */ l.createElement(ur, { "data-testid": "select", description: r, disabled: n, error: y, hideLabel: g, id: mt, inline: w, label: L, labelSecondary: C, readOnly: O, required: F, width: V }, (I) => /* @__PURE__ */ l.createElement(t3, { ...q, "aria-controls": `listbox-${mt}`, "aria-expanded": "true", "aria-haspopup": "listbox", "aria-invalid": y ? !0 : void 0, "data-testid": "select-container", role: "combobox", onClick: cn, onKeyDown: Or, $disabled: !!n, $hasError: !!y, $readOnly: O, $showDot: ue, $size: de, $validated: !!te, id: `combo-${mt}`, ref: Fe, tabIndex: B, onBlur: z, onFocus: A }, /* @__PURE__ */ l.createElement(r3, { $disabled: !!n, $hasError: !!y, $readOnly: O, $size: de }, /* @__PURE__ */ l.createElement(n3, { ref: Ae, ...I == null ? void 0 : I.content, "aria-hidden": !0, disabled: n, name: ce, placeholder: u, readOnly: O, tabIndex: -1, value: it, onChange: (N) => {
    const je = N.target.value, tr = M == null ? void 0 : M.find((tl) => tl.value === je);
    ...
    flex: "1",
    height: "100%"
  }, value: Pt, onChange: on, onKeyDown: (N) => Or(N) }) : $e ? /* @__PURE__ */ l.createElement(el, { "data-testid": "selected", option: $e }) : /* @__PURE__ */ l.createElement(Pc, { color: "$greyPrimary", pointerEvents: "none" }, u), vr ? /* @__PURE__ */ l.createElement(c3, { $disabled: n, $size: de, type: "button", onClick: sn }, /* @__PURE__ */ l.createElement(rn, null)) : O ? null : /* @__PURE__ */ l.createElement(i3, { $direction: v, $disabled: n, $open: Ne, $size: de, id: "chevron", type: "button", onClick: () => ot(!Gt) }, /* @__PURE__ */ l.createElement(Ja, null))), /* @__PURE__ */ l.createElement(o3, { $align: J, $direction: v, $rows: K, $size: de, $state: an.status, id: `listbox-${mt}`, role: "listbox", tabIndex: -1, onMouseLeave: hn }, /* @__PURE__ */ l.createElement(s3, { $direction: v, $rows: K, $size: de }, At.length === 0 && /* @__PURE__ */ l.createElement(d3, null, ae), At.map((N, je) => /* @__PURE__ */ l.createElement(h3, { $selected: (N == null ? void 0 : N.value) === it, $highlighted: je === Ke, gap: ln, $color: N.color, $size: de, "data-option-index": je, "data-testid": `select-option-${N.value}`, disabled: N.disabled, key: N.value, option: N, role: "option", type: "button", onClick: dn(N), onMouseOver: un }))))));
});
...
const v3 = l.forwardRef((r, n) => /* @__PURE__ */ l.createElement(E, { ...r, appearance: "none", as: "input", backgroundColor: {
  ...
  return /* @__PURE__ */ l.createElement(ur, { label: r, description: n, error: a, hideLabel: o, inline: h, labelSecondary: u, required: v, width: y, id: R }, (he) => /* @__PURE__ */ l.createElement(v3, { ref: ce, type: "range", ...M, ...he == null ? void 0 : he.content, defaultValue: g, disabled: w, name: L, readOnly: C, tabIndex: F, value: B, min: O, max: V, onChange: z, onBlur: T, onFocus: A, step: G }));
});
Y1.displayName = "Slider";
var m3 = tn({ defaultClassName: "dxiwpf0", variantClassNames: { showAction: { true: "dxiwpf1" } }, defaultVariants: {}, compoundVariants: [] });
const Ms = {
  small: {
    actionSize: "$10",
    iconSize: "$3",
  ...
  const o = l.isValidElement(n) ? n : /* @__PURE__ */ l.createElement(rn, null);
  return /* @__PURE__ */ l.createElement(E, { ...a, alignItems: "center", as: "button", color: {
    base: "$greyPrimary",
    hover: "$greyBright"
  ...
  return /* @__PURE__ */ l.createElement(ur, { description: h, disabled: u, error: v, hideLabel: w, id: R, label: L, labelSecondary: C, readOnly: V, required: z, width: ae }, (_e) => /* @__PURE__ */ l.createElement(g3, { $disabled: u, $error: !!v, $showDot: g, $validated: y }, /* @__PURE__ */ l.createElement(p3, { ...te, ..._e == null ? void 0 : _e.content, "aria-invalid": le, $error: le, $hasAction: Ae, $size: A, autoCorrect: r, autoFocus: n, defaultValue: o, disabled: u, maxLength: F, name: B, placeholder: O, readOnly: V, ref: W, rows: T, spellCheck: G, tabIndex: M, value: K, onBlur: me, onChange: xe, onFocus: J }), Pt && /* @__PURE__ */ l.createElement(y3, { $icon: ce, $size: A, type: "button", onClick: ge }, ce || /* @__PURE__ */ l.createElement(rn, null))));
});
...
var x3 = tn({ defaultClassName: "_102unwo0", variantClassNames: { size: { small: "_102unwo1", medium: "_102unwo2", large: "_102unwo3" } }, defaultVariants: {}, compoundVariants: [] });
const w3 = (r = "accent") => {
  const n = r.match("^(.*?)(Primary|Secondary)?$"), a = (n == null ? void 0 : n[1]) || "accent";
  return `$${ct(a, "accent")}Primary`;
}, $3 = l.forwardRef(({
...
const B3 = {
  ...
  return v || !!o ? /* @__PURE__ */ l.createElement(F3, null, o && /* @__PURE__ */ l.createElement(G3, { "data-testid": "step-container" }, Array.from({
    length: o
  }, (w, R) => /* @__PURE__ */ l.createElement(Z3, { $type: u(R), "data-testid": `step-item-${R}-${u(R)}`, key: R }))), v && /* @__PURE__ */ l.createElement(D3, null, r, n)) : null;
}, Zs = ({
  open: r,
  onDismiss: n,
  alert: a,
  ...
  stepStatus: g,
  ...w
}) => /* @__PURE__ */ l.createElement(Zn, { ...w, open: r, onDismiss: n }, /* @__PURE__ */ l.createElement(eh, null, /* @__PURE__ */ l.createElement(th, { alert: a, title: o, subtitle: h, currentStep: v, stepCount: y, stepStatus: g }), u)), nn = ({
  children: r,
  onDismiss: n,
  onClose: a,
  open: o,
  ...
  if (h === "actionable") {
    ...
    return /* @__PURE__ */ l.createElement(Zs, { ...O, alert: g, open: o, subtitle: R, title: w, onDismiss: n }, r, /* @__PURE__ */ l.createElement(rh, { leading: y, trailing: v, center: L, currentStep: C, stepCount: F, stepStatus: B }), V && /* @__PURE__ */ l.createElement(Ba, { onClick: V }));
  } else if (h === "closable") {
    const {
      alert: v,
      title: y,
    ...
    return /* @__PURE__ */ l.createElement(Zs, { ...w, alert: v, open: o, subtitle: g, title: y, onDismiss: n }, r, R && /* @__PURE__ */ l.createElement(Ba, { onClick: R }));
  }
...
const nh = (r) => /* @__PURE__ */ l.createElement(E, { ...r, as: /* @__PURE__ */ l.createElement(Xa, null), cursor: "pointer", opacity: {
  ...
  const C = l.useRef(null), [F, B] = l.useState(0.025 * window.innerHeight), [O, V] = l.useState([]);
  l.useEffect(() => {
    n && B(0.025 * window.innerHeight);
  }, [n]), l.useEffect(() => {
    const A = 0.025 * window.innerHeight;
    if (O.length && !w) {
      let G = !1, M = O[O.length - 1];
      M === void 0 && (M = O[O.length - 2] || 0, G = !0);
      const K = parseInt(getComputedStyle(document.documentElement).fontSize), ae = O[0] - M;
  ...
  const z = l.useCallback((A) => {
    ...
    A.preventDefault(), V((G) => {
      var M;
      return [...G, (M = A.targetTouches.item(0)) == null ? void 0 : M.pageY];
    });
  }, []);
  return l.useEffect(() => {
    const A = C.current;
