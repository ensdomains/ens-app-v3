...
const SliderComponent = styled.input(({
  ...
  disabled
    ...
    `}
  `);
const Slider = React.forwardRef((_W, ref) => {
  var _X = _W, {
    label,
    description,
    error,
