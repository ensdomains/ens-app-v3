...
export declare const DynamicPopover: {
    ({ popover, placement, mobilePlacement, animationFn: _animationFn, anchorRef, onShowCallback, width, mobileWidth, useIdealPlacement, additionalGap, transitionDuration, isOpen, align, hideOverflow, }: DynamicPopoverProps): React.JSX.Element;
    displayName: string;
};
