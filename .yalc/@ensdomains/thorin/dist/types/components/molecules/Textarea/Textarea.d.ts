...
} & Omit<NativeTextareaProps, 'children' | 'value' | 'defaultValue' | 'aria-invalid'>;
export declare const Textarea: React.ForwardRefExoticComponent<Omit<FieldBaseProps, "inline"> & {
    ...
    /** The handler for focus events. */
    onFocus?: NativeTextareaProps['onFocus'];
} & Omit<NativeTextareaProps, "value" | "defaultValue" | "aria-invalid" | "children"> & React.RefAttributes<HTMLTextAreaElement>>;
export {};
