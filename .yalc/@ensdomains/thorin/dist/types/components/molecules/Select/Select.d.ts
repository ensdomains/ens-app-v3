...
declare type NativeSelectProps = React.AllHTMLAttributes<HTMLInputElement>;
...
export declare type SelectProps = Omit<FieldBaseProps, 'inline'> & {
...
export declare const Select: React.ForwardRefExoticComponent<Omit<FieldBaseProps, "inline"> & {
    /** The id attribute of div element. */
    id?: NativeSelectProps['id'];
    /** If true, prevents user interaction with component. */
