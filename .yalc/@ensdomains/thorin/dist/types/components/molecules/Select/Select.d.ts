...
export declare const Select: React.ForwardRefExoticComponent<{
    ...
    size?: Size | undefined;
    /** Overide the padding setting of the element */
    padding?: "none" | "0" | "0.5" | "auto" | "0.25" | "1" | "4" | "max" | "min" | "2" | "3" | "6" | "px" | "0.75" | "1.25" | "1.5" | "1.75" | "2.5" | "3.5" | "4.5" | "5" | "5.5" | "7" | "7.5" | "8" | "8.5" | "9" | "10" | "11" | "12" | "13" | "14" | "15" | "16" | "18" | "20" | "22.5" | "24" | "26" | "28" | "30" | "32" | "36" | "40" | "44" | "45" | "48" | "52" | "56" | "60" | "64" | "72" | "80" | "96" | "112" | "128" | "144" | "168" | "192" | "224" | "256" | "288" | "320" | "1/4" | "1/3" | "1/2" | "2/3" | "3/4" | "full" | "fit" | "viewHeight" | "viewWidth" | {
        outer?: "none" | "0" | "0.5" | "auto" | "0.25" | "1" | "4" | "max" | "min" | "2" | "3" | "6" | "px" | "0.75" | "1.25" | "1.5" | "1.75" | "2.5" | "3.5" | "4.5" | "5" | "5.5" | "7" | "7.5" | "8" | "8.5" | "9" | "10" | "11" | "12" | "13" | "14" | "15" | "16" | "18" | "20" | "22.5" | "24" | "26" | "28" | "30" | "32" | "36" | "40" | "44" | "45" | "48" | "52" | "56" | "60" | "64" | "72" | "80" | "96" | "112" | "128" | "144" | "168" | "192" | "224" | "256" | "288" | "320" | "1/4" | "1/3" | "1/2" | "2/3" | "3/4" | "full" | "fit" | "viewHeight" | "viewWidth" | undefined;
        inner?: "none" | "0" | "0.5" | "auto" | "0.25" | "1" | "4" | "max" | "min" | "2" | "3" | "6" | "px" | "0.75" | "1.25" | "1.5" | "1.75" | "2.5" | "3.5" | "4.5" | "5" | "5.5" | "7" | "7.5" | "8" | "8.5" | "9" | "10" | "11" | "12" | "13" | "14" | "15" | "16" | "18" | "20" | "22.5" | "24" | "26" | "28" | "30" | "32" | "36" | "40" | "44" | "45" | "48" | "52" | "56" | "60" | "64" | "72" | "80" | "96" | "112" | "128" | "144" | "168" | "192" | "224" | "256" | "288" | "320" | "1/4" | "1/3" | "1/2" | "2/3" | "3/4" | "full" | "fit" | "viewHeight" | "viewWidth" | undefined;
    } | undefined;
    /** The size attribute for input element. Useful for controlling input size in flexboxes. */
    inputSize?: number | {
