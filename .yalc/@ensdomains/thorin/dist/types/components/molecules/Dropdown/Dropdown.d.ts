...
export declare const Dropdown: {
    ({ children, buttonProps, items, chevron, align, width, mobileWidth, shortThrow, keepMenuOnTop, label, direction, isOpen: _isOpen, setIsOpen: _setIsOpen, indicatorColor, responsive, cancelLabel, ...props }: Props & (PropsWithIsOpen | PropsWithoutIsOpen)): React.JSX.Element;
    displayName: string;
};
export {};
