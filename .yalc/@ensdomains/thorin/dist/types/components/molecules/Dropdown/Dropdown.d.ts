...
export declare const Dropdown: {
    ({ children, buttonProps, items, chevron, align, menuLabelAlign, width, mobileWidth, shortThrow, keepMenuOnTop, label, direction, isOpen: _isOpen, setIsOpen: _setIsOpen, indicatorColor, ...props }: Props & (PropsWithIsOpen | PropsWithoutIsOpen)): JSX.Element;
    displayName: string;
};
export {};
