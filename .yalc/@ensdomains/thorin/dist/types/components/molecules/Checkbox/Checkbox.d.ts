...
import { WithColorStyle } from './utils/getValueForColorStyle';
...
} & Omit<FieldBaseProps, "labelRight"> & Omit<NativeInputProps, "color" | "value" | "size" | "type" | "defaultValue" | "aria-invalid" | "children"> & WithColorStyle & React.RefAttributes<HTMLInputElement>>;
export {};
