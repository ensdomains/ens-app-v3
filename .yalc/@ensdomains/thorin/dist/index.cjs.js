"use strict";Object.defineProperties(exports,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}});var Me=require("react"),n=require("styled-components"),To=require("react-dom"),It=require("react-transition-state");function Vo(e){return e&&typeof e=="object"&&"default"in e?e:{default:e}}function Yt(e){if(e&&e.__esModule)return e;var t=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});return e&&Object.keys(e).forEach(function(o){if(o!=="default"){var a=Object.getOwnPropertyDescriptor(e,o);Object.defineProperty(t,o,a.get?a:{enumerable:!0,get:function(){return e[o]}})}}),t.default=e,Object.freeze(t)}var r=Yt(Me),u=Vo(n),Mo=Yt(To);const Bo=u.default.div(({theme:e,$shape:t,$noBorder:o})=>n.css`
  ...
  `),Go=u.default.img(({$shown:e,$disabled:t})=>n.css`
    ...
    ${t&&n.css`
      filter: grayscale(1);
    `}
  `),Pe=({label:e,noBorder:t=!1,shape:o="circle",src:a,placeholder:s,decoding:l="async",disabled:i=!1,...c})=>{const d=r.useRef(null),[g,C]=r.useState(!!a),b=r.useCallback(()=>{C(!0)},[C]),w=r.useCallback(()=>{C(!1)},[C]);return r.useEffect(()=>{const f=d.current;return f&&(f.addEventListener("load",b),f.addEventListener("loadstart",w),f.addEventListener("error",w)),()=>{f&&(f.removeEventListener("load",b),f.removeEventListener("loadstart",w),f.removeEventListener("error",w))}},[d,w,b]),r.createElement(Bo,{$noBorder:!g||t,$shape:o},!g&&r.createElement(Po,{$disabled:i,$url:s,"aria-label":e}),r.createElement(Go,{...c,$disabled:i,$shown:g,alt:e,decoding:l,ref:d,src:a,onError:()=>C(!1),onLoad:()=>C(!0)}))};Pe.displayName="Avatar";const qe=u.default.div(({theme:e,$state:t,$empty:o})=>n.css`
    width: 100vw;
    height: 100vh;
    position: fixed;
    overflow: hidden;
...
`,Ho=u.default.div(({theme:e,$color:t,$size:o})=>n.css`
  ...
  `),Ie=u.default.div(({theme:e,$inline:t})=>`
    color: ${e.colors.red};
    padding: 0 ${t?"0":e.space[4]};
`),St=(e,t,o)=>typeof o=="string"?o:(o==null?void 0:o[e])||t,X=({children:e,description:t,error:o,hideLabel:a,id:s,label:l,labelSecondary:i,required:c,inline:d,width:g="full",labelRight:C=!1,labelPlacement:b,...w})=>{const f=ir({id:s,description:t!==void 0,error:o!==void 0});let x;typeof e=="function"?x=r.createElement(kt.Provider,{value:f},r.createElement(kt.Consumer,null,y=>e(y))):e?x=r.cloneElement(e,f.content):x=e;const h=St("description","bottom",b),v=St("error","bottom",b);return d?r.createElement(Et,{$inline:d,$labelRight:C,$width:g},r.createElement(un,null,a?r.createElement(q,null,r.createElement(Te,{...w,ids:f,label:l,labelSecondary:i,required:c})):r.createElement(Te,{...w,ids:f,label:l,labelSecondary:i,required:c,$inline:d}),t&&r.createElement(_e,{$inline:d},t),o&&r.createElement(Ie,{"aria-live":"polite",...f.error,$inline:d},o)),r.createElement("div",null,x)):r.createElement(Et,{$width:g},a?r.createElement(q,null,r.createElement(Te,{...w,ids:f,label:l,labelSecondary:i,required:c})):r.createElement(Te,{...w,ids:f,label:l,labelSecondary:i,required:c}),t&&h==="top"&&r.createElement(_e,{...f.description},t),o&&v==="top"&&r.createElement(Ie,{"aria-live":"polite",...f.error},o),x,t&&h==="bottom"&&r.createElement(_e,{...f.description},t),o&&v==="bottom"&&r.createElement(Ie,{"aria-live":"polite",...f.error},o))};X.displayName="Field";const gn=(e,t)=>{const o=t==null?void 0:t.split(", ");if(!o)return!0;const a=Lt(e);return o.some(s=>{const l=Lt(s);return l.type===a.type&&l.subtype===a.subtype})},Lt=e=>{const t=e.split("/");return{type:t[0],subtype:t[1]}},Rt={},Ke=r.forwardRef(({accept:e,autoFocus:t,children:o,defaultValue:a,disabled:s,error:l,id:i,maxSize:c,name:d,required:g,tabIndex:C,onBlur:b,onChange:w,onError:f,onFocus:x,onReset:h,...v},y)=>{const $=r.useRef(null),E=y||$,[p,k]=r.useState(Rt),P=l?!0:void 0,z=ir({id:i,error:P}),G=r.useCallback((L,V)=>{if(c&&L.size>c*1e6){V==null||V.preventDefault(),f&&f(`File is ${(L.size/1e6).toFixed(2)} MB. Must be smaller than ${c} MB`);return}k(O=>({...O,file:L,name:L.name,type:L.type})),w&&w(L)},[c,w,f]),M=r.useCallback(L=>{const V=L.target.files;!(V!=null&&V.length)||G(V[0],L)},[G]),j=r.useCallback(L=>{L.preventDefault(),k(V=>({...V,droppable:!0}))},[]),Y=r.useCallback(L=>{L.preventDefault(),k(V=>({...V,droppable:!1}))},[]),ne=r.useCallback(L=>{L.preventDefault(),k(O=>({...O,droppable:!1}));let V;if(L.dataTransfer.items){const O=L.dataTransfer.items;if((O==null?void 0:O[0].kind)!=="file"||(V=O[0].getAsFile(),!V))return}else{const O=L.dataTransfer.files;if(!(O!=null&&O.length))return;V=O[0]}!gn(V.type,e)||G(V,L)},[G,e]),J=r.useCallback(L=>{k(V=>({...V,focused:!0})),x&&x(L)},[x]),U=r.useCallback(L=>{k(V=>({...V,focused:!1})),b&&b(L)},[b]),fe=r.useCallback(L=>{L.preventDefault(),k(Rt),E.current&&(E.current.value=""),h&&h()},[E,h]);return r.useEffect(()=>{!a||k({previewUrl:a.url,name:a.name,type:a.type})},[]),r.useEffect(()=>{if(!p.file)return;const L=URL.createObjectURL(p.file);return k(V=>({...V,previewUrl:L})),()=>URL.revokeObjectURL(L)},[p.file]),r.createElement("div",null,r.createElement(q,null,r.createElement("input",{...v,...z.content,accept:e,"aria-invalid":P,autoFocus:t,disabled:s,name:d,ref:E,required:g,tabIndex:C,type:"file",onBlur:U,onChange:M,onFocus:J})),r.createElement("label",{...z.label,onDragLeave:Y,onDragOver:j,onDrop:ne},o({...p,reset:fe})))});Ke.displayName="FileInput";const pn=u.default.div(({theme:e,$textAlign:t,$textTransform:o,$level:a,$responsive:s,$color:l})=>n.css`
    ${t?n.css`
          text-align: ${t};
        `:""}
    ${o?n.css`
  ...
  `),Tt=u.default.div(()=>n.css`
    display: block;
    height: 0px;
  `),cr=({topTriggerPx:e=16,bottomTriggerPx:t=16,onReachedTop:o,onReachedBottom:a,children:s,...l})=>{const i=r.useRef(null),c=r.useRef(null),d=r.useRef(null),g=r.useRef({onReachedTop:o,onReachedBottom:a}),[C,b]=r.useState(!1),[w,f]=r.useState(!1),x=h=>{var $,E,p,k;const v=[!1,-1],y=[!1,-1];for(let P=0;P<h.length;P+=1){const z=h[P],G=z.target===c.current?v:y;z.time>G[1]&&(G[0]=z.isIntersecting,G[1]=z.time)}v[1]!==-1&&b(!v[0]),y[1]!==-1&&f(!y[0]),v[0]&&((E=($=g.current).onReachedTop)==null||E.call($)),y[0]&&((k=(p=g.current).onReachedBottom)==null||k.call(p))};return r.useEffect(()=>{const h=i.current,v=c.current,y=d.current;let $;return h&&v&&y&&($=new IntersectionObserver(x,{root:h,threshold:1,rootMargin:`${e}px 0px ${t}px 0px`}),$.observe(v),$.observe(y)),()=>{$.disconnect()}},[t,e]),r.useEffect(()=>{g.current={onReachedTop:o,onReachedBottom:a}},[o,a]),r.createElement(fn,{$showBottom:w,$showTop:C,ref:i,...l},r.createElement(Tt,{"data-testid":"scrollbox-top-intersect",ref:c}),s,r.createElement(Tt,{"data-testid":"scrollbox-bottom-intersect",ref:d}))},dr=r.createContext(void 0),Je=({children:e,loading:t})=>r.createElement(dr.Provider,{value:t},e);Je.displayName="SkeletonGroup";const bn=u.default.div(({theme:e,$active:t})=>n.css`
    ${t&&n.css`
      background-color: ${e.colors.foregroundSecondary};
  ...
  `),hn=u.default.div(({theme:e})=>n.css`
    padding: 0 ${e.space[2]};
  `),Fe=({as:e="div",children:t,hover:o,label:a,size:s="medium",tone:l="secondary",...i})=>r.createElement(mn,{...i,$hover:o,$size:s,$tone:l,as:e},a&&r.createElement(wn,null,r.createElement("span",null,a)),r.createElement(hn,{as:e},t));Fe.displayName="Tag";const ve=({children:e,surface:t,onDismiss:o,noBackground:a=!1,className:s="modal",open:l})=>{const[i,c]=It.useTransition({timeout:{enter:50,exit:300},mountOnEnter:!0,unmountOnExit:!0}),d=r.useRef(null),g=t||qe,C=b=>b.target===d.current&&o&&o();return r.useEffect(()=>{const{style:b,dataset:w}=document.body,f=()=>parseInt(w.backdrops||"0"),x=v=>w.backdrops=String(f()+v),h=(v,y,$)=>{b.width=v,b.position=y,b.top=$};if(c(l||!1),typeof window!="undefined"&&!a&&l)return f()===0&&h(`${document.body.clientWidth}px`,"fixed",`-${window.scrollY}px`),x(1),()=>{const v=parseFloat(b.top||"0")*-1;f()===1&&(h("","",""),window.scroll({top:v})),x(-1)}},[l,a]),i!=="unmounted"?r.createElement(Oe,{className:s},o&&r.createElement(g,{$empty:a,$state:i,ref:d,onClick:C}),e({state:i})):null};ve.displayName="Backdrop";const Cn=(e="",t=10,o=5,a=5)=>e.length<t?e:`${e.slice(0,o)}...${e.slice(-a)}`,K=(e,t)=>e["data-testid"]?String(e["data-testid"]):t,ur=e=>t=>t[e==="small"?0:e==="large"?2:1],vn=(e,t)=>{if(Object.keys(e.colors.gradients).includes(t)){const o=t;return e.colors.gradients[o]}return e.colors[t]},yn=(e,{$size:t,$border:o,$color:a,$gradient:s})=>{const l=ur(t),i=l([e.space[12],e.space[12],e.space[20]]),c=l([e.space[6],e.space[6],e.space[10]]),d=l([e.space[7],e.space[8],e.space[12]]),g=l([e.space["3.5"],e.space[4],e.space[6]]),C=s?vn(e,a):e.colors[a],b=o?`calc(${d} - 2px)`:l([e.space[5],e.space[6],e.space[9]]),w=o?l(["1.25px","1.25px","1.75px"]):"1px",f=o?e.colors.border:e.colors.borderSecondary,x=o?"border-box":"content-box",h=o?"border-box":"content-box";return n.css`
    box-sizing: border-box;
  ...
  `),et=r.forwardRef(({description:e,disabled:t,error:o,hideLabel:a,id:s,label:l,labelSecondary:i,inline:c=!0,name:d,required:g,tabIndex:C,value:b,checked:w,width:f,onBlur:x,onChange:h,onFocus:v,variant:y="regular",color:$="blue",gradient:E=!1,background:p="grey",size:k="small",border:P=!1,...z},G)=>{const M=r.useRef(null),j=G||M;return r.createElement(X,{description:e,error:o,hideLabel:a,id:s,inline:c,label:l,labelSecondary:i,required:g,width:f},r.createElement(kn,{...z,"data-testid":K(z,"checkbox"),"aria-invalid":o?!0:void 0,type:"checkbox",$background:p,$border:P,$color:$,$gradient:E,$size:k,$variant:y,checked:w,disabled:t,name:d,ref:j,tabIndex:C,value:b,onBlur:x,onChange:h,onFocus:v}))});et.displayName="Checkbox";const En=u.default.div(()=>n.css`
    position: relative;
  ...
  `),Gn=u.default.div(()=>n.css`
    z-index: 10;
    position: relative;
  `),De=({children:e,buttonProps:t,items:o=[],inner:a=!1,chevron:s=!0,align:l="left",menuLabelAlign:i,shortThrow:c=!1,keepMenuOnTop:d=!1,size:g="medium",label:C,direction:b="down",isOpen:w,setIsOpen:f,...x})=>{const h=r.useRef(),[v,y]=r.useState(!1),[$,E]=f?[w,f]:[v,y],p=k=>{h.current&&!h.current.contains(k.target)&&E(!1)};return r.useEffect(()=>($?document.addEventListener("mousedown",p):document.removeEventListener("mousedown",p),()=>{document.removeEventListener("mousedown",p)}),[h,$]),r.createElement(Tn,{ref:h,...x,"data-testid":K(x,"dropdown")},!e&&a&&r.createElement(Pn,{$direction:b,$open:$,$size:g,type:"button",onClick:()=>E(!$)},C,s&&r.createElement(Mt,{$direction:b,$open:$})),!e&&!a&&r.createElement(Gn,null,r.createElement(Ge,{...t,pressed:$,suffix:s&&r.createElement(Mt,{$direction:b,$open:$}),onClick:()=>E(!$)},C)),r.Children.map(e,k=>{if(r.isValidElement(k))return r.cloneElement(k,{...t,zindex:10,onClick:()=>E(!$)})}),r.createElement(Bn,{align:l,direction:b,inner:a,isOpen:$,items:o,keepMenuOnTop:d,labelAlign:i,setIsOpen:E,shortThrow:c,width:h.current&&h.current.getBoundingClientRect().width.toFixed(2)}))};De.displayName="Dropdown";const zn=u.default.fieldset(({theme:e})=>n.css`
    display: flex;
    flex-direction: column;
    gap: ${e.space[4]};
  `),Hn=u.default.div(({theme:e})=>n.css`
  ...
  `),Jn=u.default.p(({theme:e})=>n.css`
    ...
    font-weight: ${e.fontWeights.bold};
    color: ${e.colors.textTertiary};
  `),no=({total:e,current:t,max:o=5,size:a="medium",alwaysShowFirst:s,alwaysShowLast:l,showElipsis:i=!0,onChange:c,...d})=>{const g=Math.floor(o/2),C=Math.max(Math.min(Math.max(t-g,1),e-o+1),1),b=Array.from({length:o},(w,f)=>C+f).filter(w=>w<=e);return e>o&&(s&&C>1?i?(b[0]=-1,b.unshift(1)):b[0]=1:i&&C>1&&b.unshift(-1),l&&e>t+g?i?(b[b.length-1]=-1*e,b.push(e)):b[b.length-1]=e:i&&e>t+g&&b.push(-1*e)),r.createElement(Xn,{...d,"data-testid":K(d,"pagebuttons")},b.map(w=>0>w?r.createElement(Jn,{"data-testid":"pagebutton-dots",key:w},"..."):r.createElement(Kn,{$selected:w===t,$size:a,"data-testid":"pagebutton",key:w,type:"button",onClick:()=>c(w)},w)))},Bt=u.default.div(({theme:e,$size:t,$hasChevron:o,$open:a})=>n.css`
    align-items: center;
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`,ds=u.default.input(({theme:e,disabled:t})=>n.css`
    ...
    ${t&&n.css`
      ...
      cursor: not-allowed;
    `}
  `),ft=r.forwardRef(({label:e,description:t,error:o,hideLabel:a,inline:s,labelPlacement:l,labelSecondary:i,required:c,width:d,defaultValue:g,disabled:C,id:b,name:w,readOnly:f,tabIndex:x,value:h,min:v=1,max:y=100,onChange:$,onBlur:E,onFocus:p,step:k="any",...P},z)=>{const G=r.useRef(null),M=z||G;return r.createElement(X,{label:e,description:t,error:o,hideLabel:a,inline:s,labelPlacement:l,labelSecondary:i,required:c,width:d,id:b},j=>r.createElement(cs,null,r.createElement(ds,{ref:M,type:"range",...P,...j==null?void 0:j.content,defaultValue:g,disabled:C,name:w,readOnly:f,tabIndex:x,value:h,min:v,max:y,onChange:$,onBlur:E,onFocus:p,step:k})))});ft.displayName="Slider";const us=u.default.div(({theme:e,$error:t,$validated:o,$showDot:a,$disabled:s})=>n.css`
    position: relative;
    background-color: ${e.colors.backgroundSecondary};
    border-radius: ${e.radii["2xLarge"]};
    border-width: ${e.space["0.75"]};
  ...
  `),bt=r.forwardRef(({autoCorrect:e,autoFocus:t,defaultValue:o,description:a,disabled:s,error:l,validated:i,showDot:c,hideLabel:d,id:g,label:C,labelSecondary:b,maxLength:w,name:f,placeholder:x,readOnly:h,required:v,rows:y=5,spellCheck:$,tabIndex:E,value:p,width:k,onChange:P,onBlur:z,onFocus:G,...M},j)=>{const Y=r.useRef(null),ne=j||Y,J=l?!0:void 0;return r.createElement(X,{description:a,error:l,hideLabel:d,id:g,label:C,labelSecondary:b,required:v,width:k},U=>r.createElement(us,{$disabled:s,$error:!!l,$showDot:c,$validated:i},r.createElement(gs,{...M,...U==null?void 0:U.content,"aria-invalid":J,$error:J,$showDot:c,$validated:i,autoCorrect:e,autoFocus:t,defaultValue:o,disabled:s,maxLength:w,name:f,placeholder:x,readOnly:h,ref:ne,rows:y,spellCheck:$,tabIndex:E,value:p,onBlur:z,onChange:P,onFocus:G})))});bt.displayName="Textarea";const ps=u.default.div(({theme:e})=>n.css`
    border-width: 1px;
    border-style: solid;
    box-sizing: border-box;
