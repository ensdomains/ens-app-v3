...
export interface SHA256Digest extends BaseContract {
    ...
    functions: {
         ...
         */
        verify(data: BytesLike, hash: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
    };
    /**
     * Verifies a cryptographic hash.
     * @param data The data to hash.
    ...
    estimateGas: {
         ...
         * @param hash The hash to compare to.
         */
        verify(data: BytesLike, hash: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        /**
         * Verifies a cryptographic hash.
         ...
         * @param hash The hash to compare to.
         */
        verify(data: BytesLike, hash: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
