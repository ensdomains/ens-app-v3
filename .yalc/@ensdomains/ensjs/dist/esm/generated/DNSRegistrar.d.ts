...
export interface DNSRegistrarInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "setPublicSuffixList", values: [string]): string;
...
export interface DNSRegistrar extends BaseContract {
    ...
    functions: {
         ...
         */
        claim(name: BytesLike, proof: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ens(overrides?: CallOverrides): Promise<[string]>;
        oracle(overrides?: CallOverrides): Promise<[string]>;
        proveAndClaim(name: BytesLike, input: DNSSEC.RRSetWithSignatureStruct[], proof: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        proveAndClaimWithResolver(name: BytesLike, input: DNSSEC.RRSetWithSignatureStruct[], proof: BytesLike, resolver: string, addr: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setOracle(_dnssec: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setPublicSuffixList(_suffixes: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
         ...
         * @param proof A DNS RRSet proving ownership of the name. Must be verified        in the DNSSEC oracle before calling. This RRSET must contain a TXT        record for '_ens.' + name, with the value 'a=0x...'. Ownership of        the name will be transferred to the address specified in the TXT        record.
         */
        claim(name: BytesLike, proof: BytesLike, overrides?: CallOverrides): Promise<void>;
        ens(overrides?: CallOverrides): Promise<string>;
        oracle(overrides?: CallOverrides): Promise<string>;
        proveAndClaim(name: BytesLike, input: DNSSEC.RRSetWithSignatureStruct[], proof: BytesLike, overrides?: CallOverrides): Promise<void>;
        proveAndClaimWithResolver(name: BytesLike, input: DNSSEC.RRSetWithSignatureStruct[], proof: BytesLike, resolver: string, addr: string, overrides?: CallOverrides): Promise<void>;
        setOracle(_dnssec: string, overrides?: CallOverrides): Promise<void>;
        setPublicSuffixList(_suffixes: string, overrides?: CallOverrides): Promise<void>;
        suffixes(overrides?: CallOverrides): Promise<string>;
        supportsInterface(interfaceID: BytesLike, overrides?: CallOverrides): Promise<boolean>;
    };
    filters: {
        "Claim(bytes32,address,bytes)"(node?: BytesLike | null, owner?: string | null, dnsname?: null): ClaimEventFilter;
        Claim(node?: BytesLike | null, owner?: string | null, dnsname?: null): ClaimEventFilter;
