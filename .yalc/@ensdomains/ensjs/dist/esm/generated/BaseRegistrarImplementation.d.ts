...
export interface BaseRegistrarImplementation extends BaseContract {
    ...
    functions: {
        ...
        addController(controller: string, overrides?: Overrides & {
        ...
        reclaim(id: BigNumberish, owner: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        register(id: BigNumberish, owner: string, duration: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        registerOnly(id: BigNumberish, owner: string, duration: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        removeController(controller: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        renew(id: BigNumberish, duration: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    filters: {
        ...
        "NameMigrated(uint256,address,uint256)"(id?: BigNumberish | null, owner?: string | null, expires?: null): NameMigratedEventFilter;
        NameMigrated(id?: BigNumberish | null, owner?: string | null, expires?: null): NameMigratedEventFilter;
        "NameRegistered(uint256,address,uint256)"(id?: BigNumberish | null, owner?: string | null, expires?: null): NameRegisteredEventFilter;
