...
export class ENS {
    constructor(options) {
        ...
        this.batch = this.generateFunction('batch', ['contracts'], 'batch');
        this._batch = this.generateFunction('batch', ['contracts'], '_batch');
        ...
        this.deleteSubname = this.generateFunction('deleteSubname', ['contracts', 'provider']);
