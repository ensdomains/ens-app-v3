...
exports.encodeContenthash = exports.getProtocolType = exports.isValidContenthash = exports.validateContent = exports.decodeContenthash = void 0;
...
function validateContent(encoded) {
    return (content_hash_1.default.isHashOfType(encoded, content_hash_1.default.Types.ipfs) ||
        content_hash_1.default.isHashOfType(encoded, content_hash_1.default.Types.swarm));
}
exports.validateContent = validateContent;
function isValidContenthash(encoded) {
    try {
        const codec = content_hash_1.default.getCodec(encoded);
        return ethers_1.utils.isHexString(encoded) && supportedCodecs.includes(codec);
    }
    catch (e) {
        console.log(e);
    }
