...
declare type OmitFirstArg<F> = F extends (x: any, ...args: infer P) => infer R
  ? (...args: P) => R
  : never
declare type OmitFirstTwoArgs<F> = F extends (
  x: any,
  y: any,
  ...args: infer P
) => infer R
...
declare type BatchFunction<F extends RawFunction> = (
  ...args: Parameters<OmitFirstArg<F['raw']>>
...
export declare class ENS {
  ...
  getProfile: (
    ...
    records?:
      | {
          contentHash?:
            | string
            | import('./utils/contentHash').DecodedContentHash
            | null
            | undefined
          texts?:
            | {
  ...
  getHistoryDetailForTransactionHash: (
    hash: string,
    indexInTransaction?: number | undefined,
  ) => Promise<
    | ({
        key: any
        value: any
    ...
    raw: (
      {
        contracts,
        universalWrapper,
      }: ENSArgs<'contracts' | 'universalWrapper'>,
      name: string,
    ) => Promise<{
      to: string
      data: string
  ...
  getAddr: GeneratedRawFunction<{
    raw: (
      ...
      name: string,
      coinType?: string | number | undefined,
    ) => Promise<{
      to: string
      data: string
    }>
    ...
    raw: (
      {
        contracts,
        multicallWrapper,
      }: ENSArgs<'contracts' | 'multicallWrapper'>,
      name: string,
    ) => Promise<{
      to: string
      data: string
  ...
  wrapName: (
    ...
    fuseOptions?:
      | string
      | number
      | import('./@types/FuseOptions').FuseOptions
      | undefined,
    resolverAddress?: string | undefined,
    options?:
      | {
