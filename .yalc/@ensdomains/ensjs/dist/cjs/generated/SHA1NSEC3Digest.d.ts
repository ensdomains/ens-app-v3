...
export interface SHA1NSEC3Digest extends BaseContract {
    ...
    functions: {
         ...
         */
        hash(salt: BytesLike, data: BytesLike, iterations: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
    };
    /**
     * Performs an NSEC3 iterated hash.
     * @param data The data to hash.
    ...
    estimateGas: {
         ...
         * @param salt The salt value to use on each iteration.
         */
        hash(salt: BytesLike, data: BytesLike, iterations: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        /**
         * Performs an NSEC3 iterated hash.
         ...
         * @param salt The salt value to use on each iteration.
         */
        hash(salt: BytesLike, data: BytesLike, iterations: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
