...
export interface ETHRegistrarControllerInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "makeCommitment", values: [string, string, BytesLike]): string;
    encodeFunctionData(functionFragment: "makeCommitmentWithConfig", values: [string, string, BytesLike, string, string]): string;
    ...
    encodeFunctionData(functionFragment: "register", values: [string, string, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "registerWithConfig", values: [string, string, BigNumberish, BytesLike, string, string]): string;
...
export interface ETHRegistrarController extends BaseContract {
    ...
    functions: {
        ...
        makeCommitment(name: string, owner: string, secret: BytesLike, overrides?: CallOverrides): Promise<[string]>;
        makeCommitmentWithConfig(name: string, owner: string, secret: BytesLike, resolver: string, addr: string, overrides?: CallOverrides): Promise<[string]>;
        ...
        register(name: string, owner: string, duration: BigNumberish, secret: BytesLike, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        registerWithConfig(name: string, owner: string, duration: BigNumberish, secret: BytesLike, resolver: string, addr: string, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        setCommitmentAges(_minCommitmentAge: BigNumberish, _maxCommitmentAge: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setPriceOracle(_prices: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        minCommitmentAge(overrides?: CallOverrides): Promise<BigNumber>;
        owner(overrides?: CallOverrides): Promise<string>;
        register(name: string, owner: string, duration: BigNumberish, secret: BytesLike, overrides?: CallOverrides): Promise<void>;
        registerWithConfig(name: string, owner: string, duration: BigNumberish, secret: BytesLike, resolver: string, addr: string, overrides?: CallOverrides): Promise<void>;
        renew(name: string, duration: BigNumberish, overrides?: CallOverrides): Promise<void>;
        renounceOwnership(overrides?: CallOverrides): Promise<void>;
        rentPrice(name: string, duration: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        setCommitmentAges(_minCommitmentAge: BigNumberish, _maxCommitmentAge: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        "NameRegistered(string,bytes32,address,uint256,uint256)"(name?: null, label?: BytesLike | null, owner?: string | null, cost?: null, expires?: null): NameRegisteredEventFilter;
        NameRegistered(name?: null, label?: BytesLike | null, owner?: string | null, cost?: null, expires?: null): NameRegisteredEventFilter;
        ...
        "NewPriceOracle(address)"(oracle?: string | null): NewPriceOracleEventFilter;
    ...
    estimateGas: {
        ...
        makeCommitment(name: string, owner: string, secret: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
        makeCommitmentWithConfig(name: string, owner: string, secret: BytesLike, resolver: string, addr: string, overrides?: CallOverrides): Promise<BigNumber>;
        maxCommitmentAge(overrides?: CallOverrides): Promise<BigNumber>;
        minCommitmentAge(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        makeCommitment(name: string, owner: string, secret: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        makeCommitmentWithConfig(name: string, owner: string, secret: BytesLike, resolver: string, addr: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
