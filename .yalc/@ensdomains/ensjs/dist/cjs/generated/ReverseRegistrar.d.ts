...
export interface ReverseRegistrarInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "claimForAddr", values: [string, string, string]): string;
    ...
    encodeFunctionData(functionFragment: "setDefaultResolver", values: [string]): string;
    encodeFunctionData(functionFragment: "setName", values: [string]): string;
    encodeFunctionData(functionFragment: "setNameForAddr", values: [string, string, string, string]): string;
...
export interface ReverseRegistrar extends BaseContract {
    ...
    functions: {
        ...
        claimForAddr(addr: string, owner: string, resolver: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        setDefaultResolver(resolver: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setName(name: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        setNameForAddr(addr: string, owner: string, resolver: string, name: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        claimForAddr(addr: string, owner: string, resolver: string, overrides?: CallOverrides): Promise<string>;
        ...
        setDefaultResolver(resolver: string, overrides?: CallOverrides): Promise<void>;
        setName(name: string, overrides?: CallOverrides): Promise<string>;
        setNameForAddr(addr: string, owner: string, resolver: string, name: string, overrides?: CallOverrides): Promise<string>;
        transferOwnership(newOwner: string, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        "ControllerChanged(address,bool)"(controller?: string | null, enabled?: null): ControllerChangedEventFilter;
        ControllerChanged(controller?: string | null, enabled?: null): ControllerChangedEventFilter;
        "OwnershipTransferred(address,address)"(previousOwner?: string | null, newOwner?: string | null): OwnershipTransferredEventFilter;
        OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): OwnershipTransferredEventFilter;
        "ReverseClaimed(address,bytes32)"(addr?: string | null, node?: BytesLike | null): ReverseClaimedEventFilter;
        ReverseClaimed(addr?: string | null, node?: BytesLike | null): ReverseClaimedEventFilter;
    };
    estimateGas: {
        claim(owner: string, overrides?: Overrides & {
            from?: string | Promise<string>;
