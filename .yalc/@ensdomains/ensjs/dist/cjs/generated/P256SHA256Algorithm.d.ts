...
export interface P256SHA256Algorithm extends BaseContract {
    ...
    functions: {
         ...
         */
        verify(key: BytesLike, data: BytesLike, signature: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
    };
    /**
     * Verifies a signature.
     * @param data The signed data to verify.
    ...
    estimateGas: {
         ...
         * @param signature The signature to verify.
         */
        verify(key: BytesLike, data: BytesLike, signature: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        /**
         * Verifies a signature.
         ...
         * @param signature The signature to verify.
         */
        verify(key: BytesLike, data: BytesLike, signature: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
