...
export interface RSASHA1Algorithm extends BaseContract {
    ...
    functions: {
        verify(key: BytesLike, data: BytesLike, sig: BytesLike, overrides?: CallOverrides): Promise<[boolean]>;
    };
    verify(key: BytesLike, data: BytesLike, sig: BytesLike, overrides?: CallOverrides): Promise<boolean>;
    callStatic: {
        verify(key: BytesLike, data: BytesLike, sig: BytesLike, overrides?: CallOverrides): Promise<boolean>;
    ...
    filters: {};
    estimateGas: {
        verify(key: BytesLike, data: BytesLike, sig: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        verify(key: BytesLike, data: BytesLike, sig: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
