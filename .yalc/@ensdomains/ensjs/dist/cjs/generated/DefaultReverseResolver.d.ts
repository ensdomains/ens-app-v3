...
export interface DefaultReverseResolver extends BaseContract {
    ...
    functions: {
        ...
        setName(node: BytesLike, _name: string, overrides?: Overrides & {
    ...
    callStatic: {
        ens(overrides?: CallOverrides): Promise<string>;
        name(arg0: BytesLike, overrides?: CallOverrides): Promise<string>;
        setName(node: BytesLike, _name: string, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
    ...
    populateTransaction: {
        ...
        name(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        setName(node: BytesLike, _name: string, overrides?: Overrides & {
            from?: string | Promise<string>;
