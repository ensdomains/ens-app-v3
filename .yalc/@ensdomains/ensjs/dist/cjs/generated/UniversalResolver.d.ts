...
export interface UniversalResolverInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "findResolver", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "registry", values?: undefined): string;
    encodeFunctionData(functionFragment: "resolve", values: [BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "resolveCallback", values: [BytesLike, BytesLike]): string;
...
export interface UniversalResolver extends BaseContract {
    ...
    populateTransaction: {
        findResolver(name: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
