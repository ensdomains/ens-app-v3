 ...
 * // 0x...
 */
declare function setRecords<TChain extends ChainWithEns, TAccount extends Account | undefined, TChainOverride extends ChainWithEns | undefined = ChainWithEns>(wallet: WalletWithEns<Transport, TChain, TAccount>, { name, resolverAddress, clearRecords, contentHash, texts, coins, abi, ...txArgs }: SetRecordsParameters<TChain, TAccount, TChainOverride>): Promise<SetRecordsReturnType>;
declare namespace setRecords {
    ...
    }, { name, resolverAddress, ...records }: SetRecordsDataParameters) => SimpleTransactionRequest;
}
