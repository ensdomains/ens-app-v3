 ...
 * // 0x...
 */
declare function setResolver<TChain extends ChainWithEns, TAccount extends Account | undefined, TChainOverride extends ChainWithEns | undefined = ChainWithEns>(wallet: WalletWithEns<Transport, TChain, TAccount>, { name, contract, resolverAddress, ...txArgs }: SetResolverParameters<TChain, TAccount, TChainOverride>): Promise<SetResolverReturnType>;
declare namespace setResolver {
    ...
    }, { name, contract, resolverAddress }: SetResolverDataParameters) => SimpleTransactionRequest;
}
