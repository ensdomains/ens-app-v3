 ...
 * // 0x...
 */
declare function setContentHashRecord<TChain extends ChainWithEns, TAccount extends Account | undefined, TChainOverride extends ChainWithEns | undefined = ChainWithEns>(wallet: WalletWithEns<Transport, TChain, TAccount>, { name, contentHash, resolverAddress, ...txArgs }: SetContentHashRecordParameters<TChain, TAccount, TChainOverride>): Promise<SetContentHashRecordReturnType>;
declare namespace setContentHashRecord {
    ...
    }, { name, contentHash, resolverAddress }: SetContentHashRecordDataParameters) => SimpleTransactionRequest;
}
