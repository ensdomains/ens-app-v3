...
declare namespace transferName {
    ...
    }, { name, newOwnerAddress, contract, reclaim, asParent, }: TransferNameDataParameters) => SimpleTransactionRequest;
}
