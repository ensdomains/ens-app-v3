 ...
 * // 0x...
 */
declare function setFuses<TChain extends ChainWithEns, TAccount extends Account | undefined, TChainOverride extends ChainWithEns | undefined = ChainWithEns>(wallet: WalletWithEns<Transport, TChain, TAccount>, { name, fuses, ...txArgs }: SetFusesParameters<TChain, TAccount, TChainOverride>): Promise<SetFusesReturnType>;
declare namespace setFuses {
    ...
    }, { name, fuses }: SetFusesDataParameters) => SimpleTransactionRequest;
}
