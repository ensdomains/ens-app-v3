 ...
 * // 0x...
 */
declare function wrapName<TName extends string, TChain extends ChainWithEns, TAccount extends Account | undefined, TChainOverride extends ChainWithEns | undefined = ChainWithEns>(wallet: WalletWithEns<Transport, TChain, TAccount>, { name, newOwnerAddress, fuses, resolverAddress, ...txArgs }: WrapNameParameters<TName, TChain, TAccount, TChainOverride>): Promise<WrapNameReturnType>;
declare namespace wrapName {
    ...
    }, { name, newOwnerAddress, fuses, resolverAddress, }: WrapNameDataParameters<TName, GetNameType<TName>>) => SimpleTransactionRequest;
}
