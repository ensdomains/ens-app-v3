 ...
 * // 0x...
 */
declare function renewNames<TChain extends ChainWithEns, TAccount extends Account | undefined, TChainOverride extends ChainWithEns | undefined = ChainWithEns>(wallet: WalletWithEns<Transport, TChain, TAccount>, { nameOrNames, duration, value, ...txArgs }: RenewNamesParameters<TChain, TAccount, TChainOverride>): Promise<RenewNamesReturnType>;
