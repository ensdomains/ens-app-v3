 ...
 * // 0x...
 */
declare function setPrimaryName<TChain extends ChainWithEns, TAccount extends Account | undefined, TChainOverride extends ChainWithEns | undefined = ChainWithEns>(wallet: WalletWithEns<Transport, TChain, TAccount>, { name, address, resolverAddress, ...txArgs }: SetPrimaryNameParameters<TChain, TAccount, TChainOverride>): Promise<SetPrimaryNameReturnType>;
declare namespace setPrimaryName {
    ...
    }, { name, address, resolverAddress, }: SetPrimaryNameDataParameters) => SimpleTransactionRequest;
}
