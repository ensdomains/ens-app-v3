...
export type DomainEventKey = 'NewOwner' | 'NewResolver' | 'Transfer' | 'NewTTL' | 'WrappedTransfer' | 'NameWrapped' | 'NameUnwrapped' | 'FusesSet' | 'ExpiryExtended';
export type RegistrationEventKey = 'NameRegistered' | 'NameRenewed' | 'NameTransferred';
export type ResolverEventKey = 'AddrChanged' | 'MulticoinAddrChanged' | 'NameChanged' | 'AbiChanged' | 'PubkeyChanged' | 'TextChanged' | 'ContenthashChanged' | 'InterfaceChanged' | 'AuthorisationChanged' | 'VersionChanged';
type Scalars = {
    ID: string;
    String: string;
    Boolean: boolean;
...
export type DomainEvent = Transfer | NewOwner | NewResolver | NewTtl | WrappedTransfer | NameWrapped | NameUnwrapped | FusesSet | ExpiryExtended;
...
export type ResolverEvent = AddrChanged | MulticoinAddrChanged | NameChanged | AbiChanged | PubkeyChanged | TextChanged | ContenthashChanged | InterfaceChanged | AuthorisationChanged | VersionChanged;
export {};
