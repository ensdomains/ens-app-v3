...
export declare type WrappedTransfer = DomainEvent & {
...
export declare type NameWrapped = DomainEvent & {
...
export declare type NameUnwrapped = DomainEvent & {
...
export declare type FusesSet = DomainEvent & {
    __typename?: 'FusesSet';
    id: Scalars['ID'];
    domain: Domain;
    blockNumber: Scalars['Int'];
...
export declare type ExpiryExtended = DomainEvent & {
...
export declare type WrappedDomain = {
...
export declare type VersionChanged = ResolverEvent & {
