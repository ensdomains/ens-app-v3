...
export type EnsSubgraphActions = {
     ...
     * // ens.eth
     */
    getDecodedName: ({ name, allowIncomplete, }: GetDecodedNameParameters) => Promise<GetDecodedNameReturnType>;
    /**
     ...
     */
    getNameHistory: ({ name, }: GetNameHistoryParameters) => Promise<GetNameHistoryReturnType>;
    /**
     ...
     */
    getNamesForAddress: ({ address, filter, orderBy, orderDirection, pageSize, previousPage, }: GetNamesForAddressParameters) => Promise<GetNamesForAddressReturnType>;
    /**
     ...
     * // }
     */
    getSubgraphRecords: ({ name, resolverAddress, }: GetSubgraphRecordsParameters) => Promise<GetSubgraphRecordsReturnType>;
    /**
     ...
     */
    getSubgraphRegistrant: ({ name, }: GetSubgraphRegistrantParameters) => Promise<GetSubgraphRegistrantReturnType>;
    /**
     ...
     */
    getSubnames: ({ name, searchString, allowExpired, allowDeleted, orderBy, orderDirection, pageSize, previousPage, }: GetSubnamesParameters) => Promise<GetSubnamesReturnType>;
};
/**
