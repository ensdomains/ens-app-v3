import { findDroppedTransactions } from './SyncDroppedTransaction'
...
describe('findDroppedTransactions', () => {
  it('should exit early if there is no connected account', () => {})
  ...
  it.todo('should handle failed transactions')
})
