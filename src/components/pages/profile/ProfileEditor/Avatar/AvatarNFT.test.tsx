  ...
  it('show load more data on page load trigger', async () => {
    ...
    await waitFor(() =>
      expect(mockedFetch.mock.lastCall).toEqual([
        `https://eth-mainnet.alchemyapi.io/nft/v2/sSpYuHmhlpuU7RVXq-IIdCdz4IuKF-gM/getNFTs/?owner=0x0000000000000000000000000000000000000001&filters%5B%5D=SPAM&pageKey=test123`,
        {
          method: 'GET',
          redirect: 'follow',
        },
