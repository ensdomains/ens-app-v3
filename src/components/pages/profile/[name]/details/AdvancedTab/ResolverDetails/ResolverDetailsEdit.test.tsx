...
describe('EditResolverForm', () => {
  it.todo(
    'should allow user to update if the have chosen to use the latest resolver',
  )
  it.todo(
  ...
  it.todo(
    'should not allow the user to use latest resolver if they already have it set',
  )
  it.todo(
    'if custom address is equal to currently set resolver, should not allow udpate',
  )
})
