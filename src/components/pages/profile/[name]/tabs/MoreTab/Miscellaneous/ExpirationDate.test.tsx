...
describe('ExpirateDate', () => {
  ...
  it('should show the Earnifi dialog when the Earnifi button is clicked', async () => {
    ...
    await waitFor(() => screen.getByText(/tabs.more.misc.reminderOptions.bankless/i))
    const earnifiButton = screen.getByText(/tabs.more.misc.reminderOptions.bankless/i)
